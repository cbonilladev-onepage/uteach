(function e(t, n, r) {
...
})(
    {
                ...
                !(function (t) {
                    t.CrayonBrush = t.util.createClass(t.BaseBrush, {
                        ...
                        onMouseDown: function (t) {
                            (this.canvas.contextTop.globalAlpha = this.opacity), (this._size = this.width / 2 + this._baseWidth), this.set(t);
                        },
                        onMouseMove: function (t) {
                            this.update(t), this.draw(this.canvas.contextTop);
                        },
                        onMouseUp: function (t) { },
                        set: function (i) {
                            this._latest ? this._latest.setFromPoint(this._point) : (this._latest = new t.Point(i.x, i.y)), t.Point.prototype.setFromPoint.call(this._point, i);
                        },
                        update: function (t) {
                            this.set(t), (this._latestStrokeLength = this._point.subtract(this._latest).distanceFrom({ x: 0, y: 0 }));
                        },
                        draw: function (i) {
                            var s, o, e, n, a, h, l, c, r, u, p, _, d, f, g;
                            for (
                                u = this._point.subtract(this._latest),
                                p = Math.ceil(this._size / 2),
                                _ = Math.floor(u.distanceFrom({ x: 0, y: 0 }) / p) + 1,
                                u.normalize(p),
                                d = this._sep * t.util.clamp((this._inkAmount / this._latestStrokeLength) * 3, 1, 0.5),
                ...
                !(function (t) {
                    t.Drip = t.util.createClass(t.Object, {
                        ...
                        initialize: function (i, e, n, o, s) {
                            (this.ctx = i), (this._point = e), (this._strokeId = s), (this.amount = t.util.getRandom(n, 0.5 * n)), (this.color = o), (this.life = 1.5 * this.amount), (i.lineCap = i.lineJoin = "round"), this._render();
                        },
                        _update: function (i) {
                            (this._lastPoint = t.util.object.clone(this._point)),
                                this._point.addEquals({ x: this.life * this.rate, y: t.util.getRandom((this.life * this.amount) / 30) }),
                                (this.life -= 0.05),
                                t.util.getRandom() < 0.03 ? (this.rate += t.util.getRandom(0.03, -0.03)) : t.util.getRandom() < 0.05 && (this.rate *= 0.01);
                        },
                        _draw: function () {
                            this.ctx.save(), this.line(this.ctx, this._lastPoint, this._point, this.color, 0.8 * this.amount + 0.2 * this.life), this.ctx.restore();
                        },
                        _render: function () {
                            function t() {
                                i._update(), i._draw(), i.life > 0 && setTimeout(t, i._interval);
                            }
                            var i = this;
                            setTimeout(t, this._interval);
                        },
                        line: function (t, i, e, n, o) {
                            (t.strokeStyle = n), (t.lineWidth = o), t.beginPath(), t.moveTo(i.x, i.y), t.lineTo(e.x, e.y), t.stroke();
                        },
                    });
                })(fabric);
            },
            ...
            function (require, module, exports) {
                !(function (t) {
                    t.InkBrush = t.util.createClass(t.BaseBrush, {
                        ...
                        changeOpacity: function (t) {
                            (this.opacity = t), (this.canvas.contextTop.globalAlpha = t);
                        },
                        _render: function (i) {
                            var s, o, n, e, h, r, a;
                            for (
                                ...
                                (a = r[e]), a.update(n, s, o), a.draw();
                            o > 30
                                ? this.drawSplash(n, this._inkAmount)
                                : 10 > o &&
                                t.util.getRandom() < 0.085 &&
                                this._dripCount &&
                                (this._drips.push(new t.Drip(this.canvas.contextTop, n, t.util.getRandom(0.25 * this.size, 0.1 * this.size), this.color, this._strokeId)), this._dripCount--);
                        },
                        onMouseDown: function (i) {
                            this._resetTip(i), (this._strokeId = +new Date()), (this._dripCount = 0 | t.util.getRandom(6, 3));
                        },
                        onMouseMove: function (t) {
                            this.canvas._isCurrentlyDrawing && this._render(t);
                        },
                        onMouseUp: function () {
                            (this._strokeCount = 0), (this._dripCount = 0), (this._strokeId = null);
                        },
                        drawSplash: function (i, s) {
                            var o,
                                ...
                                a = t.util.getRandom(12),
                                u = 10 * s,
                                l = this.color;
                            for (r.save(), e = 0; a > e; e++)
                        ...
                        setPointer: function (i) {
                            ...
                            return (this._lastPoint = t.util.object.clone(this._point)), (this._point = s), s;
                        },
                        _resetTip: function (i) {
                            var s, o, n, e;
                            for (o = this.setPointer(i), s = this._strokes = [], this.size = this.width / 5 + this._baseWidth, this._strokeNum = this.size, this._range = this.size / 2, e = 0, n = this._strokeNum; n > e; e++)
            ...
            function (require, module, exports) {
                !(function (t) {
                    t.MarkerBrush = t.util.createClass(t.BaseBrush, {
                        ...
                        _render: function (i) {
                            var n, o, s;
                            for (n = this.canvas.contextTop, n.beginPath(), s = 0, len = this._size / this._lineWidth / 2; s < len; s++)
                                (o = (this._lineWidth - 1) * s), (n.globalAlpha = 0.8 * this.opacity), n.moveTo(this._lastPoint.x + o, this._lastPoint.y + o), n.lineTo(i.x + o, i.y + o), n.stroke();
                            this._lastPoint = new t.Point(i.x, i.y);
                        },
                        onMouseDown: function (t) {
                            (this._lastPoint = t), (this.canvas.contextTop.strokeStyle = this.color), (this.canvas.contextTop.lineWidth = this._lineWidth), (this._size = this.width + this._baseWidth);
                        },
                        onMouseMove: function (t) {
                            this.canvas._isCurrentlyDrawing && this._render(t);
                        },
        ...
        5: [
            function (require, module, exports) {
                !(function (s) {
                    s.RealSprayBrush = s.util.createClass(s.BaseBrush, {
                        color: "#000000",
                        opacity: 1,
                        width: 30,
                        _baseWidth: 40,
                        ...
                        initialize: function (A, B) {
                            ...
                            (B = B || {}),
                                ...
                                this._reset(),
                                s.Image.fromURL(
                                    this.realSprayBrushDataUrl,
                                    function (s) {
                                        (t.brush = s), (t.brush.filters = []), t.changeColor(t.color || this.color);
                                    },
                                    { crossOrigin: "anonymous" }
                                );
                        },
                        changeColor: function (A) {
                            (this.color = A), (this.brush.filters[0] = new s.Image.filters.BlendColor({ color: A }))
                        },
                        changeOpacity: function (s) {
                            (this.opacity = s), (this.canvas.contextTop.globalAlpha = s);
                        },
                        ...
                        onMouseMove: function (A) {
                            (this._lastPoint = this._point), (this._point = new s.Point(A.x, A.y));
                        },
                        ...
                        _render: function () {
                            function A() {
                                ...
                                (t = new s.Point(B._point.x || 0, B._point.y || 0)),
                                    ...
                                    B._inkAmount > B._dripThreshold && (B._drips.push(new s.Drip(B.canvas.contextTop, t, B._inkAmount / 2, B.color, B._strokeId)), (B._inkAmount = 0)),
                        ...
                        _reset: function () {
                            (this._drips.length = 0), (this._point = null), (this._lastPoint = null);
                        },
                    });
                })(fabric);
            },
                    ...
                    t.Stroke = t.util.createClass(t.Object, {
                        ...
                        initialize: function (i, n, o, e, l, h) {
                            var s = t.util.getRandom(o),
                                ...
                                d = Math.cos(a),
                                _ = Math.sin(a);
                            (this.ctx = i), (this.color = e), (this._point = new t.Point(n.x + r * d - c * _, n.y + r * _ + c * d)), (this.lineWidth = l), (this.inkAmount = h), (this._currentLineWidth = l), (i.lineCap = "round");
                        },
                        update: function (i, n, o) {
                            (this._lastPoint = t.util.object.clone(this._point)), (this._point = this._point.addEquals({ x: n.x, y: n.y }));
                        ...
                        draw: function () {
                            var t = this.ctx;
                            t.save(), this.line(t, this._lastPoint, this._point, this.color, this._currentLineWidth), t.restore();
                        },
                        line: function (t, i, n, o, e) {
                            (t.strokeStyle = o), (t.lineWidth = e), t.beginPath(), t.moveTo(i.x, i.y), t.lineTo(n.x, n.y), t.stroke();
                        },
                    });
                })(fabric);
            },
                ...
                !(function (t) {
                    (t.Point.prototype.angleBetween = function (t) {
                        ...
                        (t.Point.prototype.normalize = function (t) {
                            (null === t || void 0 === t) && (t = 1);
                            var i = this.distanceFrom({ x: 0, y: 0 });
                            return i > 0 && ((this.x = (this.x / i) * t), (this.y = (this.y / i) * t)), this;
                        });
                })(fabric);
            },
            {},
            ...
            function (require, module, exports) {
                !(function (n) {
                    (n.util.getRandom = function (n, t) {
                        return (t = t ? t : 0), Math.random() * ((n ? n : 1) - t) + t;
                    }),
                        (n.util.clamp = function (n, t, u) {
                            return "number" != typeof u && (u = 0), n > t ? t : u > n ? u : n;
                        });
                })(fabric);
            },
            {},
